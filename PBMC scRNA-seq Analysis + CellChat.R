...
data_dir <- "data/sample_filtered_feature_bc_matrix"
...
pbmc_d1$DEG_annotation <- dplyr::recode(
  ...
  `3`  = "Myeloid cells",
  `4`  = "Naive B cells",
  `5`  = "Gamma-delta Cytotoxic T cells",
...
png(
  "results/figures/CellChat_communication_count_circle.png",
  width = 8,
  height = 8,
  units = "in",
  res = 300
...
png(
  "results/figures/CellChat_communication_strength_circle.png",
  width = 8,
  height = 8,
  units = "in",
  res = 300
...
write.csv(
  communication_count,
  "results/tables/CellChat_communication_count.csv"
)
...
write.csv(
  communication_weight,
  "results/tables/CellChat_communication_weight.csv"
)
...
write.csv(
  lr_results,
  "results/tables/CellChat_ligand_receptor_results.csv",
  row.names = FALSE
)
...
if (nrow(lr_results) > 0) {
  ...
  write.csv(
    top_lr,
    "results/tables/CellChat_top20_ligand_receptor_interactions.csv",
    row.names = FALSE
  )
}
...
write.csv(
  ...
  "results/tables/CellChat_signaling_pathways.csv",
  row.names = FALSE
)
...
if (!is.null(cellchat@netP$prob)) {
  ...
  write.csv(
    pathway_summary,
    "results/tables/CellChat_pathway_strength_summary.csv",
    row.names = FALSE
  )
...
write.csv(
  ...
  "results/tables/main_CellChat_pathways.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  "results/tables/secondary_CellChat_pathways.csv",
  row.names = FALSE
)
...
write.csv(
  lr_resolved,
  "results/tables/CellChat_resolved_ligand_receptor_results.csv",
  row.names = FALSE
)
...
if (nrow(lr_resolved) > 0) {
  ...
  write.csv(
    top_lr_resolved,
    "results/tables/CellChat_top40_resolved_ligand_receptor_interactions.csv",
    row.names = FALSE
  )
}
...
png(
  "results/figures/CellChat_resolved_count_circle.png",
  width = 8,
  height = 8,
  units = "in",
  res = 300
...
png(
  "results/figures/CellChat_resolved_strength_circle.png",
  width = 8,
  height = 8,
  units = "in",
  res = 300
...
write.csv(
  source_ranking,
  "results/tables/CellChat_resolved_source_ranking.csv",
  row.names = FALSE
)
...
write.csv(
  target_ranking,
  "results/tables/CellChat_resolved_target_ranking.csv",
  row.names = FALSE
)
...
write.csv(
  celltype_counts,
  "results/tables/CellChat_resolved_cell_type_composition.csv",
  row.names = FALSE
)
